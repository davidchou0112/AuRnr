...
### Sign Up a User (not sure about this API)*
...
### Create a Spot (not sure about this one)*
...
### Create a Booking from a Spot based on the Spot's id (not too sure about this)*
...
## Add Query Filters to Get All Spots (not too sure about this either)*
